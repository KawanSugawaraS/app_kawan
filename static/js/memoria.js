const MAXIMOS_INTENTOS = 8, // Intentos máximos que tiene el jugador
    ...
    NOMBRE_IMAGEN_OCULTA = "/static/imagenes/question.png"; // La imagen que se muestra cuando la real está oculta
new Vue({
    el: "#app",
    data: () => ({
        // La ruta de las imágenes. Puede ser relativa o absoluta
        imagenes: [
            "/static/imagenes/1.png",
            "/static/imagenes/2.png",
            "/static/imagenes/3.png",
            "/static/imagenes/4.png",
            "/static/imagenes/5.png",
            "/static/imagenes/6.png",
        ],
        memorama: [],
    ...
    methods: {
        mostrarCreditos() {
            Swal.fire({
                title: "Acerca de",
                html: `Creado por <a href="//parzibyte.me/blog">Kawan Sugawara</a>
                <br>
        ...
        indicarVictoria() {
            Swal.fire({
                    title: "¡Ganaste!",
                    html: `
                <img class="img-fluid" src="/static/img/gano.gif" alt="Ganaste">
